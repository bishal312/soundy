...
export function DashboardSidebar() {
  ...
  const othersMenuItems: MenuItem[] = [
    ...
    },
    {
      ...
      url: "mailto:business@soundplay.com",
      icon: Headphones,
    }
  ];
  return (
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <OrganizationSwitcher
              ...
              appearance={{
                elements: {
                  rootBox: "w-full! group-data-[collapsible=icon]:w-auto! group-data-[collapsible=icon]:flex! group-data-[collapsible=icon]:jusitfy-center!",
                  ...
                  organizationPreviewTextContainer: "text-xs! tracking-tight! font-medium! text-forground! group-data-[collapsible=icon]:hidden!",
